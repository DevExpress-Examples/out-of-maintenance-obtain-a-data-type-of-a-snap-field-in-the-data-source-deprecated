...
Namespace GetColumnType
    Partial Public Class Form1
        ...
        Private Sub ShowColumnType(ByVal dataSource As Object, ByVal dataMember As String, ByVal columnName As String)
            Dim srv As DevExpress.Snap.Services.DataAccessService = Me.snapControl1.GetService(Of DevExpress.Snap.Services.DataAccessService)()
        ...
        Private Sub btnGetColumnType1_ItemClick(ByVal sender As Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnGetColumnType1.ItemClick
            ' Get the type of the Id field in the DT1 table of the DS1 data source.
            ShowColumnType(Me.snapControl1.DataSources(0).DataSource, "DT1", "Id")
        End Sub
        Private Sub btnGetColumnType2_ItemClick(ByVal sender As Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnGetColumnType2.ItemClick
            ' Get the type of the Id field in the DT2 table of the DS2 data source.
            ShowColumnType(Me.snapControl1.Document.DataSources(1).DataSource, "DT2", "Id")
        End Sub
        Private Sub btnGetColumnType3_ItemClick(ByVal sender As Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnGetColumnType3.ItemClick
            ' Get the type of the Id field in the MyDataObjects data source.
            ShowColumnType(Me.snapControl1.DataSources("MyDataObjects").DataSource, String.Empty, "Id")
        End Sub
        Private Sub btnGetColumnType4_ItemClick(ByVal sender As Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnGetColumnType4.ItemClick
            ' Get the type of the Id field in the table linked to the Parent table via Rel1 relation
            ' in the MasterDetail data source.
            ShowColumnType(Me.snapControl1.DataSources("MasterDetail").DataSource, "Parent.Rel1", "Id")
        End Sub
        ...
        Private Sub CreateDataSources()
            ...
            dt1.Rows.Add("CCC")
            ds1.Tables.Add(dt1)
            Me.snapControl1.DataSources.Add("DS1", ds1)
            ...
            dt2.Rows.Add(3)
            ds2.Tables.Add(dt2)
            Me.snapControl1.Document.DataSources.Add("DS2", ds2)
            ' Create a list of custom objects CustomDTO and add it to the data source collection.
            Dim data As New List(Of MyDataObject)() From { _
                New MyDataObject() With {.Id = 5} _
            }
            Me.snapControl1.DataSources.Add("MyDataObjects", data)
            ' Create a DataSet with relations and add it to the data source collection.
            Dim masterDetail As New DataSet("md")
            ...
            Me.snapControl1.DataSources.Add("MasterDetail", masterDetail)
        End Sub
    End Class
